...
EXPORT void* sw_make_qbytearrayview(char* str);
EXPORT void sw_delete_qbytearrayview(void* q);
EXPORT void* sw_qbytearrayview_ptr(void* q);
EXPORT void* sw_make_qstring(char *);
EXPORT void sw_delete_qstring(void *);
EXPORT void* sw_make_qanystringview(char *);
EXPORT void sw_delete_qanystringview(void *);
EXPORT void* sw_qanystringview_ptr(void *);
